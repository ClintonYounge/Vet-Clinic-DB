...
**[Vet Clinic DB]** is a project which utilizes PostgreSQL to create a database that stores and queries the name, date of birth, and other information on animals in the clinic.
...
`git clone git remote add origin https://github.com/ClintonYounge/Vet-Clinic-DB`

or

`git clone git remote add origin https://github.com/ClintonYounge/Vet-Clinic-DB` <-- _Only if you have [SSH keys configured](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) on your GitHub account_.
